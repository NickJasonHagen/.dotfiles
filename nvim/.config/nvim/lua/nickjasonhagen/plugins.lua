...
require('lazy').setup({
    ...
    -- Plugins
    {
        ...
        event = "BufWinEnter",
        config = function()
            require('nickjasonhagen.treesitter')
        end,
        ...
        dependencies = {
            ...
            { 'windwp/nvim-ts-autotag', event = "InsertEnter" },
            {
                ...
                cmd = 'Twilight',
                config = function()
                    require('nickjasonhagen.twilight')
                end,
            },
        },
    },
            ...
            -- Autocompletion
            {
                ...
                dependencies = {
                    ...
                    -- { 'tzachar/cmp-tabnine', build = './install.sh' },
                    {
                        ...
                        config = function()
                            require('nickjasonhagen.autopairs')
                        end,
                    },
                    {'hrsh7th/cmp-buffer'},
                    {'hrsh7th/cmp-path'},
    ...
    },
    {
        ...
        config = function()
            require('nickjasonhagen.lualine')
        end,
    ...
    },
    {
        ...
        event = "BufWinEnter",
        config = function()
            require('nickjasonhagen.bufferline')
        end,
    },
    {
        ...
        config = function()
            require('nickjasonhagen.nvim-tree')
        end,
    },
    -- {
    --     "lewis6991/impatient.nvim",
    --     config = function()
    --         require('nickjasonhagen.impatient')
    --     end,
    -- },
    "moll/vim-bbye",
    ...
    'folke/which-key.nvim',
    {
        ...
        -- cmd = "Telescope",
        config = function()
            require('nickjasonhagen.telescope')
        end,
    },
    ...
    { 'nvim-telescope/telescope-live-grep-args.nvim', dependencies = 'nvim-telescope/telescope.nvim' },
    {
        ...
        config = function()
            require('nickjasonhagen.harpoon')
        end,
    },
    -- use({
    ...
    },
    {
        ...
        config = function()
            require('nickjasonhagen.lazygit')
        end,
    },
    -- use {
    ...
    --         { 'sindrets/diffview.nvim' }
    --     },
    --     config = "require('nickjasonhagen.neogit')"
    -- }
    {
        "tpope/vim-fugitive",
        cmd = {
    ...
    },
    {
        ...
        config = function()
            require('nickjasonhagen.rest-nvim')
        end,
    ...
    },
    {
        ...
        config = function()
            require('nickjasonhagen.todo')
        end,
    },
    {
        'numToStr/Comment.nvim',
        config = function()
            require('nickjasonhagen.comment')
        end,
    },
    { 'sheerun/vim-polyglot' },
    {
        ...
        config = function()
            require('nickjasonhagen.colorizer')
        end,
        event = "BufRead"
    },
    {
    ...
    },
    {
        ...
        config = function()
            require('nickjasonhagen.blankline')
        end,
        event = "BufRead"
    },
    {
        ...
        config = function()
            require('nickjasonhagen.trouble')
        end,
    },
    {
    ...
    },
    {
        ...
        cmd = 'ZenMode',
        config = function()
            require('nickjasonhagen.zen-mode')
        end,
    },
    ...
    -- JavaScript
    --use { 'posva/vim-vue', config = "require('nickjasonhagen.vue')" }
    ...
    --     },
    --     config = function()
    --         require('nickjasonhagen.neotest')
    --     end,
    -- },
...
-- {
   ...
   --  },
    ...
    -- Better LSP signature with parameter hints.
    {
        ...
        config = function()
            require('nickjasonhagen.lsp-signature')
        end,
    },
